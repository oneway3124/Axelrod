...
class TestMoranProcess(unittest.TestCase):
    ...
    def test_seeding_equality(self, seed):
        players = [axelrod.Random(x) for x in (0.2, 0.4, 0.6, 0.8)]
    ...
    def test_population_plot(self):
        ...
        rng = axelrod.RandomGenerator(seed=15)
        players = [rng.choice(axelrod.demo_strategies)() for _ in range(5)]
        mp = axelrod.MoranProcess(players=players, turns=30, seed=20)
        mp.play()
